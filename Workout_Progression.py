...
if st.session_state.logged_in:
    ...
    # To allow submission via "Enter" key, use st.text_input with on_change
    def submit_workout():
    ...
    st.text_input("Press Enter to Submit", on_change=submit_workout)

    if st.button("Add Record"):
        submit_workout()  # Call the same submit function when button is pressed
